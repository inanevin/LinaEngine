...
#define LOGPANEL_COLOR_ERR_DEFAULT ImVec4(0.6f, 0.0f, 0.0f, 1.0f) 
#define LOGPANEL_COLOR_ERR_HOVERED ImVec4(0.8f, 0.0f, 0.0f, 1.0f)
#define LOGPANEL_COLOR_ERR_PRESSED ImVec4(0.4f, 0.0f, 0.0f, 1.0f)
