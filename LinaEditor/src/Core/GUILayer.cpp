...
namespace LinaEditor
{
	...
	void GUILayer::OnAttach()
	{
		...
		colors[ImGuiCol_TitleBg] = ImVec4(0.39f, 0.10f, 0.18f, 1.00f);
		...
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.39f, 0.10f, 0.18f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.69f, 0.15f, 0.29f, 1.00f);
