...
#define OBJL_CONSOLE_OUTPUT
	...
	namespace algorithm
	{
		...
		{
			Vector3 cp1 = Lina_Vector3F::Cross(b - a, p1 - a);
			Vector3 cp2 = Lina_Vector3F::Cross(b - a, p2 - a);
		...
		Vector3 GenTriNormal(Vector3 t1, Vector3 t2, Vector3 t3)
		{
			...
			Vector3 normal = Lina_Vector3F::Cross(u,v);
		...
		bool inTriangle(Vector3 point, Vector3 tri1, Vector3 tri2, Vector3 tri3)
		{
			...
			Vector3 proj = Lina_Vector3F::Projection(point, n);
	...
	private:
			...
			std::string icurline)
		{
			...
			if (noNormal)
			{
				...
				Vector3 normal = Lina_Vector3F::Cross(A, B);
